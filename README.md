...
```json
{
  "execution_list": [
    {
      "type": "newman",
      "name": "project_name/Acquire_Token.postman_collection.json,project_name/Smoke_AgreementManagement.postman_collection.json"
    }
  ],
  "env_vars": {
...
#### TEST_PARAMS Example (legacy collections)
...
```json
{
  ...
  "maven_build": true,
  "working-dir": "project_name/files",
  "flags": [
    "--insecure",
